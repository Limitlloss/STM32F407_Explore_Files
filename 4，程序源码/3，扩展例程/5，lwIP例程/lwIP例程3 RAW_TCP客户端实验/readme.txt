 ...
 ***************************************************************************************************
 * 实验简介
 * 实验名称：lwIP RAW TCPClient 实验
 * 实验平台：正点原子 探索者F407开发板
 * 实验目的：学习lwIP RAW TCPClient接口
 ...
 ***************************************************************************************************
 * 实验现象
 * 1 获取DHCP完成之后进入远程IP地址设置界面，通过KEY0和KEY2按键设置远程IP地址，并按下KEY1保存退出。
 * 2 可接收网络调试助手发送的数据，这些数据会在LCD上显示，而用户可通过KEY0按键发送“ALIENTEK DATA\r\n”至网络调试助手。
