...
DateStruct datedemo = {"2020", "January", "01"}; /* 日期,默认初始化为1990年1月1日 */

uint8_t listwheelindex[3];   /* LISTWHEEL选中的项目号 */
/* 年 */
const char *_apYear[] =
{
...
/**
 * @brief       在LISTWHEEL0上绘制红色指示行
 * @param       pDrawItemInfo : 绘制项的信息
 * @retval      无
 */
static int emwin_listwheel0_owner_draw(const WIDGET_ITEM_DRAW_INFO *pDrawItemInfo)
{
...
/**
 * @brief       在LISTWHEEL1上绘制红色指示行
 * @param       pDrawItemInfo : 绘制项的信息
 * @retval      无
 */
static int emwin_listwheel1_owner_draw(const WIDGET_ITEM_DRAW_INFO *pDrawItemInfo)
{
    switch (pDrawItemInfo->Cmd)
    {
        case WIDGET_ITEM_DRAW_OVERLAY:
...
/**
 * @brief       在LISTWHEEL2上绘制红色指示行
 * @param       pDrawItemInfo : 绘制项的信息
 * @retval      无
 */
static int emwin_listwheel2_owner_draw(const WIDGET_ITEM_DRAW_INFO *pDrawItemInfo)
{
    switch (pDrawItemInfo->Cmd)
    {
        case WIDGET_ITEM_DRAW_OVERLAY:
...
static void _cbDialog(WM_MESSAGE *pMsg)
{
    ...
    switch (pMsg->MsgId)
    {
        ...
        case WM_INIT_DIALOG:
            ...
            LISTWHEEL_SetOwnerDraw(hItem, emwin_listwheel0_owner_draw);        /* 绘制红色指示行 */
            ...
            LISTWHEEL_SetOwnerDraw(hItem, emwin_listwheel1_owner_draw);        /* 绘制红色指示行 */
            ...
            LISTWHEEL_SetOwnerDraw(hItem, emwin_listwheel2_owner_draw);        /* 绘制红色指示行 */
