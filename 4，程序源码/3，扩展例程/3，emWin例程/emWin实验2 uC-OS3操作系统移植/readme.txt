 ...
 ***************************************************************************************************
 * 实验现象
 * 1 本实验开机后，系统创建三个任务，它们分别为USER_TASK、TOUCH_TASK和LED0_TASK。其中USER_TASK任务执行emWin官方Demo，
   而TOUCH_TASK和LED0_TASK任务的实现功能分为为：获取emWin触摸和LED0定时闪烁。
