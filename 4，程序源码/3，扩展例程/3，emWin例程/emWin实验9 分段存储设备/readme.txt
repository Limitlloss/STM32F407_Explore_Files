 ...
 ***************************************************************************************************
 * 实验简介
 * 实验名称：emwin 分段存储设备 实验
 * 实验平台：正点原子 探索者 F407开发板
 * 实验目的：学习 emwin分段存储设备函数
 ...
 ***************************************************************************************************
 * 实验现象
 * 1 USE_BANDING_MEMDEV配置项可设置本实验是否使用分段存储方式，如果此配置项为0，则四角形和两个矩形会闪烁的更新图形。
   如果此配置项为1，则这些图形先在存储器中进行偏移，再更新到显示屏，这样能有效防止屏幕闪烁。
