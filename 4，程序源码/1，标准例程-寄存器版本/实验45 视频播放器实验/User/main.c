...
int main(void)
{
    ...
    btim_timx_int_init(10000 - 1, 8400 - 1);    /* 10Khz计数,1秒钟中断一次 */
    ...
    es8388_output_cfg(1, 1);    /* 通道1/2 输出使能 */
    es8388_hpvol_set(25);       /* 设置耳机音量 */
    es8388_spkvol_set(30);      /* 设置喇叭音量 */
    
    text_show_string(30, 40, 200, 16, "正点原子STM32开发板", 16, 0, RED);
    text_show_string(30, 60, 200, 16, "视频播放实验", 16, 0, RED);
    text_show_string(30, 80, 200, 16, "正点原子@ALIENTEK", 16, 0, RED);
